...
/**
 * RawPHP_Sniffs_Formatting_BlankLineBeforeReturnSniff.
 *
 * PHP version 5
 *
 * @category PHP
 ...
 * @link     https://github.com/opensky/Symfony2-coding-standard
 */
class RawPHP_Sniffs_Formatting_BlankLineBeforeReturnSniff
    implements PHP_CodeSniffer_Sniff
{
    ...
    public function process( PHP_CodeSniffer_File $phpcsFile, $stackPtr )
    {
        ...
        {
            if ( $tokens[ $current ][ 'line' ] == $previousLine && $tokens[ $current ][ 'type' ]
                !== 'T_WHITESPACE' && $tokens[ $current ][ 'type' ] !== 'T_COMMENT'
            )
            {
        ...
        if ( isset( $prevLineTokens[ 0 ] ) && ($prevLineTokens[ 0 ] === 'T_OPEN_CURLY_BRACKET'
        ...
        {
            $phpcsFile->addError(
                'Missing blank line before return statement', $stackPtr
            );
        }
